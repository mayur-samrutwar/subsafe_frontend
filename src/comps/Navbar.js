    ...
    <div class="px-4 py-5 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
      <div class="relative flex items-center justify-between">
        <div class="flex items-center">
          ...
          >
            <svg
              ...
              strokeWidth="2"
              class="w-10 h-10 text-white p-2 bg-rose-400 rounded-full"
              viewBox="0 0 24 24"
            >
          ...
          <ul class="flex items-center hidden space-x-8 lg:flex">
            <li>
              <a
                ...
                aria-label="Donate"
                title="Donate"
                class="font-medium tracking-wide text-gray-700 transition-colors duration-200 hover:text-rose-500"
              >
                Donate
              </a>
            </li>
        ...
        <div class="lg:hidden">
          ...
          {isMenuOpen && (
            <div class="absolute bg-white top-0 left-0 w-full">
